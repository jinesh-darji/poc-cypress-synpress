...
describe("Regression Test Cases of the Send Native Token Flows", () => {
  beforeEach(() => {
  ...
  it("REGRESSION: Perform the Send Native Token Transaction with exceeded amount on Xdai Network", () => {
    cy.fixture("transaction").then((data) => {
      // select and enter the details for sending the Native token with exceeded amount
      try {
      ...
      try {
        ...
        console.error(e);
        assert.fail(
          "The estimation of the send native transaction is performed without sufficient balance."
        );
      }
  ...
  it("REGRESSION: Perform the Send Native Token Transaction with an invalid receiver address and without a receiver address on Xdai Network", () => {
    cy.fixture("transaction").then((data) => {
      // select and enter the details for sending the Native token with invalid receiver address
      try {
        // click on the send label
        home.send.click();
  ...
  it("REGRESSION: Perform the Send Native Token Transaction with zero amount and without amount on Xdai Network", () => {
    cy.fixture("transaction").then((data) => {
      // select and enter the details for sending the Native token with zero amount and without amount
      try {
        // click on the send label
        home.send.click();
        ...
        // enter the token value in the you send field
        transaction.youSend.type(data.you_send_zero); // transaction with zero amount
  ...
  it("REGRESSION: Perform the Send Native Token Transaction with the same receiver address on Xdai Network", () => {
    cy.fixture("transaction").then((data) => {
      // select and enter the details for sending the Native token with same receiver address
      try {
        // click on the send label
        home.send.click();
      ...
      try {
        // validate the transaction reverted label
        transactionreview.duplicationAddress.should("be.visible");
  ...
  it("REGRESSION: Verify the Edit Transaction Details Functionality while performing the Send Native Token on Xdai Network", () => {
    cy.fixture("transaction").then((data) => {
      ...
      // execute the updated details for sending the Native token
      try {
        // validate the execute button
        transactionreview.execute.should("be.visible");
      ...
      // submiting the updated details for sending the Native token
      try {
  ...
  it("REGRESSION: Perform the Send Native Token Transaction with Xdai Network and multiple transactions", () => {
  ...
  it("REGRESSION: Perform the Send Native Token Transaction with Matic, BNB, Xdai, Optimism, and Arbitrum Networks", () => {
    cy.fixture("transaction").then((data) => {
      // select and enter the details for sending the Native token with polugon, bnb chain, gnosis chain, optimism, and Arbitrum
      try {
        // click on the send label
        home.send.click();
        ...
        // click on the matic token option
        transaction.matic_TokenList.click();
        ...
        // click on the BNB token option
        transaction.bNB_TokenList.click();
        ...
        // click on the Optimism token option
        transaction.optimism_TokenList.click();
        ...
        // click on the Arbitrum token option
        transaction.arbitrum_TokenList.click();
      ...
      // execute the details for sending the Native token with polugon, bnb chain, gnosis chain, optimism, and Arbitrum
      try {
        // validate the execute button
        transactionreview.execute.should("be.visible");
      ...
      // submiting the details for sending the Native token with polugon, bnb chain, gnosis chain, optimism, and Arbitrum
      try {
        // validate the transaction completed label
        transactionreview.transactionCompleted.should("be.visible");
